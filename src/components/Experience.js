        ...
        <div className="mx-auto grid max-w-xl items-center gap-6 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-16">
          <div>
            <h2 className="font-display text-4xl font-semibold text-slate-900 sm:text-5xl">
              ...
              <span className="relative whitespace-nowrap">
                ...
                <span className="relative text-sky-700">senior</span>
              </span>{' '}
              developper
            </h2>
          </div>
          <div>
            <p className="text-lg leading-8 text-slate-700">
              As a senior freelance web developer, I bring a unique set of
              skills and qualities that distinguish me from others in the
              industry to ensure the highest quality outcome.
            </p>
          </div>
        </div>
                  ...
                  <div className="relative flex space-x-7">
                    ...
                    <div>
                      ...
                      <p className="mt-2.5 text-base text-slate-700">
                        I excel in identifying and addressing performance
                        bottlenecks, ensuring applications run efficiently and
                        effectively.
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative pb-24 lg:pb-20">
                  ...
                  <div className="relative flex space-x-7">
                    ...
                    <div>
                      ...
                      <p className="mt-2.5 text-base text-slate-700">
                        Quality and robustness are at the forefront of
                        everything I do.
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative">
                  <div className="relative flex space-x-7">
                    ...
                    <div>
                      ...
                      <p className="mt-2.5 text-base text-slate-700">
                        As a senior developer, I bring a wealth of knowledge and
          ...
          <div className="lg:col-span-8 lg:pl-8 xl:pl-24">
            <div className="aspect-h-2 aspect-w-3 relative w-full">
              ...
              <div>
                ...
                <dl className="absolute bottom-0 right-1/2 grid w-max translate-x-1/2 translate-y-3/4 grid-cols-1 gap-5 rounded-2xl bg-sky-700/90 px-6 py-8 text-center backdrop-blur-sm sm:translate-y-1/2 sm:gap-12 sm:p-10 lg:right-20 lg:translate-x-0">
